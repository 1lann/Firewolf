...
local serverID = "cloud"
local serverList = {experimental = "Experimental", other = "Other", cloud = "Cloud/Lite"}
...
local databaseURL = "https://raw.github.com/1lann/firewolf/master/databases/" .. serverID .. 
	"-database.txt"
local serverURL = "https://raw.github.com/1lann/firewolf/master/server/server-cloud.lua"
...
local function loadSite(site)
	...
	local function runSite(content, antivirusEnv)
		...
		-- Run
		local fn, err = env.loadstring(content)
...
--  Swap protocols by clicking them menubar. For 3.0
